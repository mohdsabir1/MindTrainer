...
import Wall from '../../../assets/Impact/1.png'
import Wall1 from '../../../assets/Impact/2.jpg'
import Wall2 from '../../../assets/Impact/3.png'
export const ImpactCards = () => {
    ...
    return (
        ...
        {Cards.map((card, index) => (
                ...
                <div key={index} className="lg:flex  lg:w-96 lg::space-x-5 lg:h-fit md:h-fit md:mx-auto md:mb-10 rounded-lg md:w-96  border-[1px]  lg:mb-10 lg:mt-8 mb-8">
                    <div className='rounded-lg bg-[#eff2f7]'>
                        ...
                        <h2 className='lg:p-2  lg:mt-4 text-3xl lg:text-center lg:font-medium md:text-center md:mt-2 text-center mt-3 tracking-tight text-textcolor'>{card.heaing}</h2>
